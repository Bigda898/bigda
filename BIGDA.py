...
\33[1;32m -----------------------------------------------
\33[1;32m OWNER : BIGDA NAWAB
\33[1;32m FACEBOOK : https://www.facebook.com/profile.php?id=100078238744142&mibextid=ZbWKwL
\33[1;32m NUMBER : +1 (520) 254-5162
\33[1;32m CREATED BY : BIGDA NAWAB BAREND 
-----------------------------------------------"""
...
def sendtextconvo(comment):
    ...
    print (e.strftime("HAN MESSAGE SEND KARDIA BIGDA NA :: Date - %d/%m/%Y  Time - %I:%M:%S %p"))
    print(">> BIGDA NAWAB BAREND>>> :: ", yyy+ ' ' +line, "\n")

print("\033[1;33;40m", end = "")
os.system('clear')
print(logo)
sp("\033[1m\033[36m[+] EMAIL DALO  \n")
print(47*'\33[1;36m-')
USERNAME = str(input('[?] NUMBER YA EMAIL DAL YAR: '))
print("\33[1;36m", end = "")
print(47*'\33[1;36m-')
sp("\33[1;36m[+] OWKA PASSWORD DONE KAR\n")
print(47*'\33[1;36m-')
PASSWORD = str(input('[?] : '))
login()
